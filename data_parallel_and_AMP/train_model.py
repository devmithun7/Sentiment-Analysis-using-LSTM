...
def train_model(model, train_loader, val_loader, criterion, optimizer, epochs, batch_size, device, rank, world_size, embedding_dim, hidden_dim, n_layers, save_dir, scaler):
    '''
